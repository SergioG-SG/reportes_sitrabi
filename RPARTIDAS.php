...
$url2 = $env == 'p' ? "http://186.151.206.62/app/coope/api/contabilidad-tipo-de-polizas?filters[empresa][\$eq]=" . $empresa : "http://100.78.93.50:8009/api/contabilidad-tipo-de-polizas?filters[empresa][\$eq]=" . $empresa;
...
$url3 = $env == 'p' ? "http://186.151.206.62/app/coope/api/centros-de-costos?filters[empresa][\$eq]=" . $empresa : "http://100.78.93.50:8009/api/centros-de-costos?filters[empresa][\$eq]=" . $empresa;
