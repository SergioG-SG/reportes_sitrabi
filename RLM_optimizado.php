...
foreach ($respuesta as $key) {
    ?>
    <tr>
        <td class="fecha_registro"><?= $key['codigo_titulo'] ?></td>
        <td class="fecha_registro"><?= $key['nombre_cuenta'] ?></td>
        <td class="fecha_registro"></td>
        <td class="fecha_registro"></td>
        <td class="fecha_registro"></td>
        <td class="fecha_registro" style="font-size: 8px;"></td>
        <td class="fecha_registro" style="font-size: 8px;"></td>
    </tr>
    <tr>
        <td class="estilo_celda fondo_gris_titulo">Fecha</td>
        <td class="estilo_celda fondo_gris_titulo" style="text-align: center;">No.Documento</td>
        <td class="estilo_celda fondo_gris_titulo" style="text-align: center;">Centro de costo</td>
        <td class="estilo_celda fondo_gris_titulo" style="text-align: center;">Póliza</td>
        <td class="estilo_celda fondo_gris_titulo centrar_texto">DEBE</td>
        <td class="estilo_celda fondo_gris_titulo centrar_texto">HABER</td>
        <td class="estilo_celda fondo_gris_titulo centrar_texto">SALDO</td>
    </tr>
    <?php
    $sumatoria_debe = 0;
    $sumatoria_haber = 0;
    ...
    foreach ($key['registros_por_fecha'] as $cuentas_) {
        ...
        foreach ($cuentas_['registros'] as $regs_) {
            ...
            ?>
            <tr>
                <td class="estilo_celda" style="width: 20%;"><?= date('d/m/Y', strtotime($regs_['fecha'])) ?></td>
                <td class="estilo_celda" style="width: 10%;text-align: center;"><?= $regs_['numero_documento'] ?></td>
                <td class="estilo_celda" style="text-align: center;width: 15%"><?= $regs_['centro_de_costo'] ?></td>
                <td class="estilo_celda" style="width: 10%;text-align: center;"><?= $nombre_poliza_ ?></td>
                <td class="estilo_celda" style="width: 15%;text-align: center;"><?= $_debe ?></td>
                <td class="estilo_celda" style="text-align: center;width: 15%;"><?= $_haber ?></td>
                <td class="estilo_celda" style="text-align: center;width: 15%;">Q<?= number_format($saldo_actual, 2, '.', ',') ?></td>
            </tr>
            <?php
            if ($regs_['monto'] > 0) {
        ...
        <tr>
            ...
            <td></td>
            <td></td>
            <td style="border-bottom: 1px solid #e9e9e9;"></td>
            <td style="border-bottom: 1px solid #e9e9e9;"></td>
            <td style="border-bottom: 1px solid #e9e9e9;"></td>
        </tr>
        <tr>
            <td class="estilo_celda fondo_gris_titulo">TOTAL DEL DIA:</td>
            <td></td>
            <td></td>
            <td></td>
            <td class="estilo_celda" style="text-align: center;font-weight: bold;font-size:12px;">Q<?= number_format($cuentas_['sub_suma_debe'], 2, '.', ',') ?></td>
            <td class="estilo_celda" style="text-align: center;font-weight: bold;font-size:12px;">Q<?= number_format($cuentas_['sub_suma_haber'], 2, '.', ',') ?></td>
            <td class="estilo_celda" style="text-align: center;font-weight: bold;font-size:12px;">Q(<?= number_format($sumatoria_saldo_actual, 2, '.', ',') ?>)</td>
        </tr>
        <tr>
    ...
    <tr>
        ...
        <td class="estilo_celda"></td>
        <td class="estilo_celda"></td>
        <td class="estilo_celda fondo_gris_titulo" style="text-align: right;">Sumas</td>
