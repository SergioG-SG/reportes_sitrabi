...
$url = $env == 'p' ? "https://cooperativasitrabi.ddns.net/app/coope/api/contabilidad-transaccion-cabeceras/c/reporte_balance_saldos" : "http://localhost:8009/api/contabilidad-transaccion-cabeceras/c/reporte_balance_saldos";

$url2 = $env == 'p' ? "https://cooperativasitrabi.ddns.net/app/coope/api/centros-de-costos/c/nombre/" . $centro_de_costo : "http://localhost:8009/api/centros-de-costos/c/nombre/" . $centro_de_costo;
...
$html = '
        ...
        <div class="titulo_sub">
            DEL ' . date('d/m/Y', strtotime($fecha_inicial)) . ' AL ' . date('d/m/Y', strtotime($fecha_final)) . ' <br> CENTRO DE COSTO:  <b>' . $nombre_centro_de_costo . '</b>
        </div>
        <div class="titulo_sub">
            (CIFRAS EN QUETZALES)
        </div>
...
foreach ($listado as $key) {
    ...
    $sub_total_col_1_ = $key['sub_total_col_1'] == 0 ? '' : 'Q' . number_format($key['sub_total_col_1'], 2, '.', ',');
    $sub_total_col_2_ = $key['sub_total_col_2'] == 0 ? '' : 'Q' . number_format($key['sub_total_col_2'], 2, '.', ',');
    $sub_total_col_3_ = $key['sub_total_col_3'] == 0 ? '' : 'Q' . number_format($key['sub_total_col_3'], 2, '.', ',');
        ...
        if ($key['posicion'] == 1) {
            $html .= '
                <tr>
                    ...
                    <td class="estilo_celda centrar_texto" style="width: ' . $row_3 . '%;">Q' . number_format($resultado_['saldo_final'], 2, '.', ',') . '</td>
                    <td class="estilo_celda centrar_texto" style="width: ' . $row_4 . '%;">' . $sub_total_col_2_ . '</td>
                    <td class="estilo_celda centrar_texto" style="width: ' . $row_5 . '%;">' . $sub_total_col_3_ . '</td>
                </tr>
            ';
