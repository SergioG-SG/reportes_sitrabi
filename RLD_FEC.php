...
$url = $env == 'p' ? "https://cooperativasitrabi.ddns.net/app/coope/api/contabilidad-transaccion-cabeceras/c/reporte_libro_diario" : "http://localhost:8009/api/contabilidad-transaccion-cabeceras/c/reporte_libro_diario";
$url2 = $env == 'p' ? "https://cooperativasitrabi.ddns.net/app/coope/api/contabilidad-tipo-de-polizas" : "http://localhost:8009/api/contabilidad-tipo-de-polizas";
