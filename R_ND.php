...
$url = $env == 'p' ? "http://coopesitrabi.ddns.net/app/coope/api/bancos-transacciones/c/listado_notas_debito?fi=" . $fecha_inicial . "&ff=" . $fecha_final . "&cuenta=" . $cuenta : "http://localhost:8009/api/bancos-transacciones/c/listado_notas_debito?fi=" . $fecha_inicial . "&ff=" . $fecha_final . "&cuenta=" . $cuenta;
