...
$url = $env == 'p' ? "http://cooperativasitrabi.ddns.net/app/coope/api/bancos-transacciones/c/listado_notas_debito?fi=" . $fecha_inicial . "&ff=" . $fecha_final . "&cuenta=" . $cuenta : "http://localhost:8009/api/bancos-transacciones/c/listado_notas_debito?fi=" . $fecha_inicial . "&ff=" . $fecha_final . "&cuenta=" . $cuenta;
...
$html = '
    ...
    <div class="titulo_sub">
        LISTADO DE NOTAS DE DÉBITO DEL ' . date('d/m/Y', strtotime($fecha_inicial)) . ' AL ' . date('d/m/Y', strtotime($fecha_final)) . '
    </div>
