...
$html .= '
        ...
        <tr>
            ...
            <td class="estilo_celda"></td>
            <td class="estilo_celda"></td>
            <td class="estilo_celda" style="font-size: 14px;font-weight: bold;text-align: center;">GRAN TOTAL</td>
            <td class="estilo_celda" style="font-size: 14px;font-weight: bold;text-align: center;">Q'. number_format($gran_suma_debe, 2, '.', ',')  .'</td>
            <td class="estilo_celda" style="font-size: 14px;font-weight: bold;text-align: center;">Q'. number_format($gran_suma_haber, 2, '.', ',') .'</td>
            <td class="estilo_celda" style="font-size: 14px;font-weight: bold;text-align: center;">Q'. number_format($gran_total, 2, '.', ',') .'</td>
        </tr>
