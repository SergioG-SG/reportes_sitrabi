...
$url = $env == 'p' ? "http://186.151.206.62/app/coope/api/contabilidad-transacciones?filters[id_random][\$eq]=". $ids . "&pagination[page]=1&pagination[pageSize]=500" : "http://100.78.93.50:8009/api/contabilidad-transacciones?filters[id_random][\$eq]=". $ids . "&pagination[page]=1&pagination[pageSize]=500";


$url2 = $env == 'p' ? "http://186.151.206.62/app/coope/api/contabilidad-transaccion-cabeceras?filters[id_random][\$eq]=" . $ids : "http://100.78.93.50:8009/api/contabilidad-transaccion-cabeceras?filters[id_random][\$eq]=" . $ids;


$url4 = $env == 'p' ? "http://186.151.206.62/app/coope/api/contabilidad-tipo-de-polizas" : "http://100.78.93.50:8009/api/contabilidad-tipo-de-polizas";
...
function obtener_nombre_cuenta($codigo, $token, $empresa, $env){
    ...
    $url_3 = $env == 'p' ? "http://186.151.206.62/app/coope/api/catalogo-de-cuentas?filters[codigo_formateado][\$eq][0]=". $codigo ."&filters[empresa][\$eq][1]=1" : "http://100.78.93.50:8009/api/catalogo-de-cuentas?filters[codigo_formateado][\$eq][0]=". $codigo ."&filters[empresa][\$eq][1]=" . $empresa;
...
$url5 = $env == 'p' ? "http://186.151.206.62/app/coope/api/centros-de-costos/c/nombre/" . $cabecera[data][0][attributes][centro_de_costo] : "http://100.78.93.50:8009/api/centros-de-costos/c/nombre/" . $cabecera[data][0][attributes][centro_de_costo];
